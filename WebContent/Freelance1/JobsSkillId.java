...
/**
 * JobsSkillId generated by hbm2java
 */
@Embeddable
public class JobsSkillId implements java.io.Serializable {
	...
	public JobsSkillId(Integer id, Integer skillId) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof JobsSkillId))
			return false;
		JobsSkillId castOther = (JobsSkillId) other;
