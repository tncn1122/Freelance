				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="col-lg-8 formRegister" style = "padding: 50px">
							<h2>Đánh Giá Về Hệ Thống Freelance</h2>
							<br>
                            <h6>Mỗi lời nhận xét của bạn là nguồn động lực cũng như là tiền đề để chúng tôi ngày càng phát triển và tiến bộ hơn.</h6>
                            <br>
                            ${message}
							<form:form class="form-area contact-form" modelAttribute="ratingContent" id="ratingForm"
							action="user/${ratingContent.id}/rating.htm" method="post">
								<div class="row">	
