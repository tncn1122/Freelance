			...
			<section class="blog-posts-area section-gap">
				<div class="container">
					<div class="row">
						...
						<!-- GIỚI THIỆU CHUNG -->
							<div class="col-lg-12">
								<form:form modelAttribute="jobInfo" class="form-area contact-form" id="jobForm"
								action="job/edit/${jobInfo.getId()}.htm" method="post" >
				...
				<!--  Kỹ năng -->				
											...
											<div style = "text-align: center">
												<c:choose>
													<c:when test="${jobOffer == null}">
														<button name = "deleteBtn" id = "deleteBtn" style="margin-right: 90px;" class="primary-btn mt-20 text-white";">Hủy Dự Án</button>
													</c:when>
												</c:choose> 
												<button name = "submitBtn" id = "submitBtn" class="primary-btn mt-20 text-white";">Sửa Dự Án</button>
											</div>
