					...
					<div class="row">
						...
						<div class="col-lg-4 sidebar">
							<div class="single-widget">
								...
								<div class = "ratingStar" title="This is my tooltip">
									...
									<c:choose>
										<c:when test="${userInfo.getType()}">
											<ul>
												...
												<li><a  class="justify-content-between align-items-center d-flex"><h6>Xem Đánh Giá</h6>
												 <span><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${userInfo.getThuChi()}" /></span></a></li> 
											</ul>	
						...
						<!-- GIỚI THIỆU CHUNG -->
							<div class="col-lg-8">
								<div class="single-post">
										...
										<h5>
											<c:choose>
												<c:when test="${userInfo.getGioiThieu() == null}">Bí Mật!</c:when>
											...
											<div class="user-details row align-items-center">
												<div class="comment-wrap col-lg-6">
													...
													<c:choose>
														<c:when test="${jobInfo.getHoanThanh()}">
															<li><span class="lnr lnr-checkmark-circle"></span> Hoàn Thành</li>
														</c:when>
														<c:otherwise >
												...
												<div class="social-wrap col-lg-6">
													<ul>
														...
														<c:choose>
															<c:when test="${jobInfo.getHoanThanh()}">
															<li><a><fmt:formatNumber type = "number" pattern = ",##0" value = "${jobInfo.getNganSachDen()}"/> VNĐ</a></li>
															</c:when>
															<c:otherwise >
																<li><a>
